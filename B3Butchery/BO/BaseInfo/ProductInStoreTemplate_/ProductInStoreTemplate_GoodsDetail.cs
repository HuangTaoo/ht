...
{
	[DFClass, Serializable, LogicName("成品入库模板_存货明细")]
	public class ProductInStoreTemplate_GoodsDetail : Base
	{
	...
	[Serializable]
	public class ProductInStoreTemplate_GoodsDetailCollection : DmoCollection<ProductInStoreTemplate_GoodsDetail>
	{ }
}
