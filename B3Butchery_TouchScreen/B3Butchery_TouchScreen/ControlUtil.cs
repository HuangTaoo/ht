...
namespace B3Butchery_TouchScreen
{
  public class ControlUtil
  {
    public static Panel CreateGridPanel(GridConfig gridConfig)
    {
      ...
      panel.Controls.Add(CreateBiaoShiLable());
      panel.Controls.Add(CreateNumberText(gridConfig));
      ...
      panel.Controls.Add(CreateOkButton());
    ...
    private static void BtnDelete_Click(object sender, EventArgs e)
    {
      ...
      var gridConfig = txt.Tag as GridConfig;
    ...
    private static void BtnSet_Click(object sender, EventArgs e)
    {
      ...
      var gridConfig = btnSet.Tag as GridConfig;
    ...
    private static void Button_Click(object sender, EventArgs e)
    {
      ...
      btn.Parent.Controls.Find("textBox", true)[0].Text = "3232";
    }
    ...
    static TextBox CreateNumberText(GridConfig gridConfig)
    {
      ...
      text.Multiline = true;
      text.ReadOnly = true;
      text.Size = new System.Drawing.Size(121, 60);
    ...
    static Label CreateBiaoShiLable()
    {
      var lable = new Label();
