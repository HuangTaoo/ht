...
namespace BWP.Web.Pages.B3Butchery.Reports.ProductPlanReport_
{
  class ProductPlanReport : DFBrowseGridReportPage
  {
    DFInfo mainInfo = DFInfo.Get(typeof(ProductPlan));
    DFInfo detailInfo = DFInfo.Get(typeof(ProductPlan_OutputDetail));

    CheckBoxListWithReverseSelect checkbox;

    protected override string AccessRoleName
    {
      get { return "B3Butchery.生产计划.访问"; }
    }
    ...
    string[]sumFileds = new string[] { "PlanNumber", "PlanSecondNumber" };
