...
namespace BWP.Web.Pages.B3Butchery.Reports.ProduceInputReport_
{
	class ProduceInputReport : DFBrowseGridReportPage
	{
		DFInfo mainInfo = DFInfo.Get(typeof(ProduceInput));
		DFInfo detailInfo = DFInfo.Get(typeof(ProduceInput_Detail));
		protected override string AccessRoleName
		{
			get { return "B3Butchery.报表.投入单分析"; }
		}
