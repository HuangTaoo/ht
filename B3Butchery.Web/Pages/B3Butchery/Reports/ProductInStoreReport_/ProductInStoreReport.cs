...
{
  public class ProductInStoreReport : DFBrowseGridReportPage
  {

    public const string CustomMainFieldBegin = "__Cus_Main_";
    ...
    protected virtual void AddOtherQuery(LayoutManager manger, DFInfo mainInfo)
    {

    }

    protected virtual void SetQueryResult(DQueryDom query, ListItem field)
    {
