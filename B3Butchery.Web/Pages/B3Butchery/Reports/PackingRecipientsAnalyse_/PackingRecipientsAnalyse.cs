...
namespace BWP.Web.Pages.B3Butchery.Reports.PackingRecipientsAnalyse_
{
  class PackingRecipientsAnalyse : DFBrowseGridReportPage<PackingRecipients>
  {
